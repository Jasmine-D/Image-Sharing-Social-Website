...
// *: shallow copy, inner code will effect the outer world
func uploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "Failed to read media file from request", http.StatusBadRequest)
		fmt.Printf("Failed to read media file from request %v\n", err)
		return
	}

	suffix := filepath.Ext(header.Filename)
	// t: hashmap value; ok: true/false
